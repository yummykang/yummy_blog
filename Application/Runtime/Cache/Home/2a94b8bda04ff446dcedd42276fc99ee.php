...
<!--End banner img-->
    ...
    <div class="container-fluid main-container" id="main-container">
        ...
        <!--main Start-->
        <?php if(is_array($articles)): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="row">
        ...
        <div class="row">
            <div class="col-md-12 post-container">
                <div class="row">
                    <div class="col-md-4">
                        <a class="btn btn-primary home-browser-more-btn" href="<?php echo U('Blog/index');?>">
                            <span>浏览更多文章</span>
                        </a>
                    </div>
                    <div class="col-md-8">
