    ...
    <div class="row top-title">
        <div class="col-md-12">
            <h1 class="page-title right">
                <a href="<?php echo U('Blog/index');?>">博客</a> >> <a href="<?php echo U('Blog/index', array('category'=>$article['category_id']));?>"><?php echo ($article["category"]); ?></a>
            </h1>
        </div>
    </div>
    <div class="row">
...
<script src="/Public/static/leaves/assets/APlayer/dist/APlayer.min.js"></script>
<script src="/Public/static/leaves/assets/APlayer/demo/demo.js"></script>
<script>
    /*banner 初始化*/
